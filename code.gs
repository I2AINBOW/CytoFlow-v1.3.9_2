// =====================================================================
// CytoFlow v1.3.9 AI Core - Multi-Database Architecture (SaaS Ready)
// =====================================================================
...
function doGet() {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('CytoFlow 2026 (v1.3.9 AI Core)')
...
// --- API: STICKER CONFIG (v1.3.9 AI Core) ---
...
function apiGetStickerConfig() {
  try {
    ...
    let config = {
      ...
      barcodeWidth: 1.5,   // ความกว้าง/สเกลของเส้นบาร์โค้ด (เผื่อจับหมุนแนวตั้งแล้วยาวเกิน)
    ...
    if (!sheet) {
      ...
      const descriptions = {
        ...
        barcodeWidth: "สเกลความกว้าง/ความยาวของบาร์โค้ด",
